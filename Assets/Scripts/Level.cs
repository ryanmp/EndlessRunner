...
public class Level : MonoBehaviour
{
	...
	void Start ()
	{
		...
		//// new type of gen
		GameObject floor = Instantiate (platform2, Vector3.zero, Quaternion.identity) as GameObject;
		Dictionary<string, object> to_send2 = new Dictionary<string, object> () {
			{ "start_pos", new Vector2(-1f,-3f)},
			{ "end_pos", new Vector2(390f,-10f)},
			{ "amplitude", 0.5f },
			{ "freq", 95f },
			{ "phase_mod_speed", 0.02f }


		};
		floor.SendMessage ("Init", to_send2);
